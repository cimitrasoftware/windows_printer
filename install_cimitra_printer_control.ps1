...
$CIMITRA_JSON_DOWNLOAD = "https://raw.githubusercontent.com/cimitrasoftware/windows_printer/main/ControlPrinter.json"
...
$CIMITRA_JSON_DOWNLOAD_OUT_FILE = "$INSTALLATION_DIRECTORY\ControlPrinter.json"
